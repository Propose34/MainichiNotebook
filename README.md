...
> *"The best gifts aren't bought in stores—they are crafted with care, patience, and purpose."*

Mainichi Notebook was born out of a desire to create something truly special for an upcoming anniversary with my partner, who was passionately studying Japanese.

Observing their daily study routine, I noticed how fragmented and friction-heavy language learning can be. They had to constantly jump across multiple separate apps: generic flashcard tools for spaced repetition, standard PDF readers for lecture handouts, handwriting note apps for kana drills, and online dictionaries for audio pronunciation. None of the mainstream note-taking apps catered specifically to the unique nuances of Japanese study—such as traditional **Genkouyoushi (原稿用紙)** manuscript grids, kanji stroke-order guides, or Cornell-style grammar synthesis.

To celebrate our milestone together, I decided to build a dedicated, all-in-one Japanese study companion from the ground up using native Swift, SwiftUI, and Apple PencilKit. 

The app's motto, **「継続は力なり」 (*Keizoku wa chikara nari* — Consistency is power)**, reflects not only the patient daily dedication needed to master a language, but also the enduring care that nurtures a relationship over time. What began as a personal gift has grown into a production-grade, privacy-first study companion designed to bring joy and focus to anyone on their Japanese learning journey.
